...
<tr><td><b>Integrated terminal</b></td><td>A real shell alongside your chat. The header has a <code>+</code> button that opens a new session — point it at another folder to work on a different project, no shortcuts to remember.</td></tr>
