...
<tr><td><b>Integrated terminal with tabs</b></td><td>Real shells alongside your chat. The <code>+</code> in the header opens another terminal tab; click a tab to switch, <code>✕</code> to close. Tabs are <b>per session</b> — each chat keeps its own set, and a tab's shell stays alive (scrollback and all) when you switch away and back.</td></tr>
